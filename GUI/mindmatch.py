"""Author: Kayla Sallee
    Purpose: This Python program helps users find therapists based on their preferences, such as gender and specialty, using a 
    graphical interface built with Tkinter and BreezyPythonGUI
